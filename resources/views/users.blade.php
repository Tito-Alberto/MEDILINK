...
@section('title', 'Usuarios - Medlink')

@section('content')
<div class="flex flex-wrap items-end justify-between gap-4">
    <div>
        <p class="text-xs uppercase tracking-[0.3em] text-lime-700">Painel</p>
        <h1 class="brand-title text-4xl text-slate-900">Usuarios</h1>
        <p class="text-sm text-slate-500">Acompanhe o cadastro e a atividade dos usuarios.</p>
    </div>
        ...
        <table class="min-w-full text-sm">
            <thead class="bg-white/90 text-xs uppercase tracking-widest text-slate-500">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left">Data de registro</th>
